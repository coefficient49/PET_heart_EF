...
% volumeViewer(squeeze(bwLV(:,:,:,6)))
% figure
% for sb = 1: 8
%     subplot(2,4,sb)
%     imshow(squeeze(bwLV(:,:,round(s(3)/2),sb)))
%     hold on
%     plot(x,y,'*')
%     hold off
%     title('xy - plane')
...
% for sb = 1: 8
%     subplot(2,4,sb)
%     imshow(squeeze(bwLV(round(s(1)/2),:,:,sb)))
%     title('yz - plane')
% end
%
% % volumeViewer(squeeze(BWt(:,:,:,6)))
% figure
% for sb = 1: 8
%     subplot(2,4,sb)
%
%     imshow(squeeze(BWt(:,:,round(s(3)/2),sb)))
%     hold on
%     plot(x,y,'*')
%     hold off
%     title('xy - plane')
...
% for sb = 1: 8
%     subplot(2,4,sb)
%     imshow(squeeze(BWt(round(s(1)/2),:,:,sb)))
%     title('yz - plane')
% end
